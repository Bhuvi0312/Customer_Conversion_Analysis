 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "25a69bdb-a6c8-410f-924a-3009ee601e06",
   "metadata": {},
   "outputs": [],
   "source": [
    "#Libraries\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "38e81b27-186a-407e-837d-c6b7b84c0916",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "90eccc50-c6d0-42b4-998a-549a6823d282",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "b75b4a3d-88f2-43ca-8900-ed7ec0edecab",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "5a1ae8ac-324e-4dc6-977c-82c47c2e0426",
   "metadata": {},
   "outputs": [],
   "source": [
    "#Data Preprocessing\n",
    ...
    "\n",
    "    #Numerical Pipeline\n",
    "    numerical_pln = pipeline(steps=[\n",
    "        ('imputer',SimpleImputer(strategy='mean')),\n",
    "        ('scaler',StandardScaler())\n",
    "    ])\n",
    "\n",
    "    #Categorical Pipeline\n",
    "    categorical_pln = pipeline(steps=[\n",
    "        ('imputer',SimpleImputer(strategy='most frequent')),\n",
    "        ('encoder',OneHotEncoder(handle_unknown='ignore'))\n",
    "    ])\n",
    "\n",
    "    #Combining the using ColumnTransformer\n",
    "    preprocessor = ColumnTranformer(transformers=[\n",
    "        ('num',numerical_pln,numeric_features),\n",
    "        ('cat',categorical_pln,categorical_features)\n",
    "    ])\n",
    "    return preprocessor\n",
    "    "
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "4af67781-8790-4ec7-962b-e1e06ce5d3a4",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   ...
   "id": "a5fc4838-b995-41d1-ab8d-2746ce037f8b",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "636622af-df3a-4ddb-bc7a-812130fa6040",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "10f0412f-97fa-4457-aa21-86c9e1ce097e",
   "metadata": {},
   "outputs": [],
   "source": []
  }
